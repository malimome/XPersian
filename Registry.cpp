...
char* CRegistry::GetString(LPCTSTR pszSection, LPCTSTR pszName, LPCTSTR pszDefault)
{
	...
	//sprintf
	//strKey="Software\\XPersian\\%s" +  pszSection ;
	sprintf(strKey,"Software\\XPersian\\%s",pszSection);
...
int CRegistry::GetInt(LPCTSTR pszSection, LPCTSTR pszName, int nDefault)
{
	...
	//strKey="Software\\XPersian\\XPersian\\%s" +  pszSection ;
	sprintf(strKey,"Software\\XPersian\\%s",pszSection);
...
BOOL CRegistry::SetInt(LPCTSTR pszSection, LPCTSTR pszName, int nValue)
{
	...
	//strKey=_T("XPersian\\XPersian\\%s") +  pszSection ;
	sprintf(strKey,"Software\\XPersian\\%s",pszSection);
